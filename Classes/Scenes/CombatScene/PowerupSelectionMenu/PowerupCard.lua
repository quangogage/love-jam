...
function PowerupCard:_printName(y)
    ...
    love.graphics.printf(self.name, self.position.x + TEXT_PADDING/2, y, WIDTH - TEXT_PADDING, "center")
...
function PowerupCard:_printDescription(y)
    ...
    love.graphics.printf(self.description, self.position.x + TEXT_PADDING/2, y, WIDTH - TEXT_PADDING, "center")
